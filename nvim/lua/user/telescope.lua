...
vim.keymap.set('n', 'fd', function() builtin.diagnostics({ initial_mode = "normal" }) end, {})
...
vim.keymap.set("n", "<space>fb", function() fb.file_browser({ initial_mode = "normal" }) end, { noremap = true })
